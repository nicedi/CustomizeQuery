...
var w2utils = (function ($) {
    ...
    var obj = {
        ...
        settings : {
            ...
            "timeFormat"        : "h24:mi:ss",
            "datetimeFormat"    : "yyyy-mm-dd h24:mi:ss",
            "currencyPrefix"    : "¥",
            "currencySuffix"    : "",
            "currencyPrecision" : 2,
            "groupSymbol"       : ",",
            ...
            "phrases" : {
                ...
                "Add New": "添加",
                "AJAX error. See console for more details.": "AJAX错误，更多信息查看控制台。",
                "All Fields": "全部字段",
                "Are you sure you want to delete selected records?": "确定删除选中的数据吗？",
                "Attach files by dragging and dropping or Click to Select": "通过拖放或点击选择添加文件。",
                "begins": "以...开始",
                "between": "范围",
                "buffered": "缓存",
                "Clear Search": "清除搜索",
                ...
                "Hide": "隐藏",
                "in": "在...之中(多个数值用逗号隔开)",
                "not in": "不在...之中(多个数值用逗号隔开)",
                "is": "等于",
                "Load": "加载",
                "More": "更多",
                "Multi Fields": "多个字段",
                "Multiple Fields": "多个字段",
                "No items found": "未找到数据项",
                "No": "否",
                "none": "空",
                "Not a float": "不是小数",
                "Not a hex number": "不是16进制数",
                "Not a valid date": "不是有效的日期",
                "Not a valid email": "不是有效的邮件地址",
                "Not alpha-numeric": "不是字母或数字",
                "Not an integer": "不是整数",
                "Not in money format": "不是金额格式",
                "Notification": "通知",
                "of": "/",
                "Ok": "好",
                "Open Search Fields": "打开查询字段",
                "Record ID": "记录ID",
                "Records": "数据",
                "Refreshing...": "刷新中...",
                "Reload data in the list": "重新加载列表数据",
                "Remove": "确认删除",
                "Required field": "必填项目",
                "Reset Column Size": "重置列宽",
                "Reset": "重置",
                "Return data is not in JSON format. See console for more information.": "返回的数据不是JSON格式，查看控制台以获取更多信息。",
                "Returned data is not in valid JSON format.": "返回的数据不是有效的JSON格式。",
                "Save changed records": "保存数据",
                "Save": "保存",
                "Saving...": "保存中...",
                "Search took ": "查询耗时 ",
                "Search": "查询",
